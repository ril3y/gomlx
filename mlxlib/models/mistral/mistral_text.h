...
// A single Mistral transformer layer.
struct MistralLayer {
    // Attention norms
...
class MistralTextModel : public BaseModel {
public:
    explicit MistralTextModel(const ModelConfig& config);
    ...
    std::vector<int> stop_token_ids() const override { return {2}; }
