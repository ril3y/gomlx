...
MistralTextModel::MistralTextModel(const ModelConfig& config)
    : config_(config) {
...
void MistralTextModel::load_linear(
...
void MistralTextModel::load_weights(const std::string& path) {
...
array MistralTextModel::linear_forward(
    const array& input,
...
array MistralTextModel::attention(
    int layer_idx,
    const array& x,
    int offset) {
...
array MistralTextModel::mlp(int layer_idx, const array& x) {
    auto& layer = layers_[layer_idx];
...
array MistralTextModel::run_layer(
    int layer_idx,
    const array& x,
    int offset) {
    auto& layer = layers_[layer_idx];
...
array MistralTextModel::forward(const array& tokens, int offset) {
...
void MistralTextModel::reset_cache() {
    kv_cache_->reset();
}
